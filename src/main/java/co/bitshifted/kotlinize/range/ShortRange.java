...
/**
 * A range of {@code short} values.
 * This class represents a sequence of short integers from a start value to an end value (inclusive).
 */
public final class ShortRange extends Range<Short> {

  /**
   * Creates a new {@code ShortRange} with a specified step.
  ...
  /**
   * Creates a new {@code ShortRange} with a default step of 1.
   * The range includes all values from {@code start} to {@tcode endInclusive}.
   * If {@code start} is greater than {@code endInclusive}, the range will be decreasing.
   *
   * @param start the starting value of the range
   * @param endInclusive the ending value of the range (inclusive)
