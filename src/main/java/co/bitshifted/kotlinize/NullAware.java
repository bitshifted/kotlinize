...
/**
 * A utility class that provides Kotlin-like null safety features in Java. It aims to replicate the following Kotlin
 * features:
 *
 * <ul>
 *     <li>Safe call operator ({@code ?.}): Allows safe access to properties and methods of potentially null objects.</li>
 *     <li>Elvis operator ({@code ?:}): Provides a way to return a default value if the underlying value is null.</li>
 *     <li>{@code apply} function: Executes a block of code with the underlying value and returns the value itself.</li>
 *     <li>{@code let} function: Executes a block of code with the underlying value if it is not null, returning the result of the block.</li>
 * </ul>
 *
...
public final class NullAware<T> {
    ...
    /**
     * Replicates Kotlin's {@code apply} functionality. Executes the provided block with the underlying value
     * and returns the value itself. Function block can alter the state of the underlying value if it is mutable.
     *
    ...
    /**
     * Replicates Kotlin's {@code let} functionality. If underlying value is not null, executes the provided block
     * with the value. Otherwise, returns null.
     *
     * @param block function to execute with the underlying value
    ...
    /**
     * Replicates Kotlin's Elvis operator ({@code ?:}) functionality. If underlying value is null, executes
     * the provided block and returns its result.
     *
    ...
    /**
     * Creates a {@code  NullAware} instance by executing the provided supplier. If a NullPointerException
     * is thrown during the execution, the underlying value is set to null.
     *
    ...
    /**
     * Executes the provided supplier and returns its value. If a {@code NullPointerException}
     * is thrown during the execution, {@code null} is returned.
     *
     * @param supplier function to provide the value
    ...
    /**
     * Executes the provided supplier and returns its value. If a {@code NullPointerException}
     * is thrown during the execution, the provided default value is returned.
     *
     * @param supplier function to provide the value
     * @param defaultValue value to return if supplier throws NullPointerException, or value evaluates to null
