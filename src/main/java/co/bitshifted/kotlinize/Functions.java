 ...
 *
 * <ul>
 *   <li>arrayOf: Creates an array from the given elements, including per-type variants
 *   <li>lazy: create lazy initialized instance
 *   <li>repeat: Repeats a block of code a specified number of times
 *   <li>require: Checks a condition and throws IllegalArgumentException if false
 *   <li>requireNonNull: Ensures an object is not null, throwing IllegalArgumentException if it is
 *   <li>runCatching: Executes a block of code and captures any thrown exceptions
 *   <li>TODOfunction - throws UnsupportedOperationException -
 * </ul>
 */
public final class Functions {
  ...
  /**
   * Checks the given condition and throws an {@code IllegalArgumentException} if the condition is
   * false.
   *
  ...
  /**
   * Checks the given condition and throws an {@code IllegalArgumentException} with the provided
  ...
  /**
   * Ensures the provided value is not null and returns it; throws IllegalArgumentException with a
   * default message if it is null.
   *
   * @param value value to check for null
   * @param <T> type of the value
   * @return the non-null value
  ...
  /**
   * Executes the given block of code and returns a {@code Result} representing either the
   * successful result or any exception that was thrown during execution.
   *
   * @param block the block of code to execute
