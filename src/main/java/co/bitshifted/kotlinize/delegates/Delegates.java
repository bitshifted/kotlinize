...
/**
 * A utility class that provides factory methods for creating delegated properties, similar to
 * Kotlin's standard library delegates. This class provides implementations for `observable` and
 * `vetoable` properties.
 */
public final class Delegates {
   ...
   *
   * @param callback a function that will be called after the property value has been changed. The
   *     function receives the old and new values.
   ...
   *
   * @param callback a function that will be called before the property value is changed. The
   *     function receives the old and new values and should return {@code true} to allow the change
   *     or {@code false} to veto it.
   * @param <T> the type of the property value
