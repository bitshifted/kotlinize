...
public class Nullsafety {
    ...
    void example() {
        ...
        try {
            ...
            System.out.println("Caught NullPointerException when accessing null property: " + ex.getMessage());
        }
        // using NullAware to safely access potentially null properties. This will not throw an exception
